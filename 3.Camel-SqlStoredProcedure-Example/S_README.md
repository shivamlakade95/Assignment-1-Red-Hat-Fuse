...
___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
___________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________
karaf@root()> features:addurl file:/home/slakade/Downloads/GitRepos/Shivam-RedHatFuse-Assignment-1/Assignment-1-Red-Hat-Fuse/3.Camel-SqlStoredProcedure-Example/feature.xml
Adding feature url file:/home/slakade/Downloads/GitRepos/Shivam-RedHatFuse-Assignment-1/Assignment-1-Red-Hat-Fuse/3.Camel-SqlStoredProcedure-Example/feature.xml

karaf@root()> features:install camelstoredprocedure

karaf@root()> features:info camelstoredprocedure
Feature camelstoredprocedure 1.2.0
Feature has no configuration
Feature has no configuration files
Feature depends on:
  camel-sql 0.0.0
Feature contains followed bundles:
  mvn:org.apache.commons/commons-dbcp2/2.7.0.redhat-00001 (overriden from mvn:org.apache.commons/commons-dbcp2/2.1.1)
  mvn:org.apache.commons/commons-pool2/2.8.0.redhat-00001 (overriden from mvn:org.apache.commons/commons-pool2/2.6.2)
  mvn:org.mariadb.jdbc/mariadb-java-client/2.7.3
  mvn:com.mycompany/sql-storedprocedure/1.0
Feature has no conditionals.

karaf@root()> features:
features:addurl             features:install            features:listurl            features:removerepository
features:chooseurl          features:list               features:listversions       features:removeurl
features:info               features:listrepositories   features:refreshurl         features:uninstall
